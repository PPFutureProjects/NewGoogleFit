    ...
    private void buildFitnessClient() {
        if (mClient == null && checkPermissions()) {
            ...
            GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                    .requestEmail()
                    .requestScopes(new Scope(Scopes.FITNESS_ACTIVITY_READ_WRITE), new Scope(Scopes.FITNESS_LOCATION_READ_WRITE))
                    .build();
...
//                                    Snackbar.LENGTH_INDEFINITE).show();
                            ...
                            Toast.makeText(MainActivity.this, "Exception while connecting to Google Paly services: ", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .build();
        }
